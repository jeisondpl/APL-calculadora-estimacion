      ...
      {user && (
        <div className="flex items-center gap-3">
          ...
          <span
            ...
            style={{
              backgroundColor: `${ROL_COLORS[rolKey] ?? '#888'}18`,
              color:           ROL_COLORS[rolKey] ?? '#888',
            }}
          >
          ...
          <div
            ...
            style={{ backgroundColor: ROL_COLORS[rolKey] ?? '#888' }}
          >
          ...
          <button
            ...
            title="Cerrar sesión"
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all hover:bg-red-50"
